...
api.add_resource(User, '/user', methods=['GET', 'PUT', 'DELETE'], endpoint='modifyuser')
api.add_resource(User, '/user/register', methods=['POST'], endpoint='useregister')
api.add_resource(UsersList, '/userslist')
api.add_resource(Post, '/post', methods=['GET', 'POST'], endpoint='createpost')
api.add_resource(Post, '/post/<post_id>', methods=['PUT', 'DELETE'], endpoint='modifypost')
